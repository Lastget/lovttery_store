...
from base.serializer import ProductSerializer, serializers, UserSerializer, UserSerializerWithToken
...
def registerUser(request):
    # Django REST reques.data 
    data = request.data

    try:
        # send the request data object from frontend.  
        ...
        message = {'detail': 'User with this email existed'}
...
def updateUserProfile(request):
    ...
    if data['password'] != '': 
        user.passwword = make_password(data['password'])
